...
export WIN32_AS_PROJECT_PATH := "C:\projects\MIG\MIG_26Sept2025K\MIG1"
...
export WIN32_AS_TEMP_PATH := "C:\projects\MIG\MIG_26Sept2025K\MIG1\Temp"
export WIN32_AS_BINARIES_PATH := "C:\projects\MIG\MIG_26Sept2025K\MIG1\Binaries"
...
ProjectMakeFile:
	...
	@'$(AS_BIN_PATH)/4.9/BR.AS.AnalyseProject.exe' '$(AS_PROJECT_PATH)/MIG1.apj' -t '$(AS_TEMP_PATH)' -c '$(AS_CONFIGURATION)' -o '$(AS_BINARIES_PATH)'   -sfas -buildMode 'Build'   
