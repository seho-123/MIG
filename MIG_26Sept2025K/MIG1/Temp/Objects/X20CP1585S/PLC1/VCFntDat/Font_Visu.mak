...
$(AS_CPU_PATH)/VcFntDat/verabd.ccf:$(AS_CPU_PATH)/VcFntDat/verabd.vco
	 $(LINK) '$^' -o '$@' -warningLevel2 -m verabd.ttf -name Visu -profile 'False' -vcr 4732 -sfas
...
$(AS_CPU_PATH)/VcFntDat/arialbi.ccf:$(AS_CPU_PATH)/VcFntDat/arialbi.vco
	 $(LINK) '$^' -o '$@' -warningLevel2 -m arialbi.ttf -name Visu -profile 'False' -vcr 4732 -sfas

$(AS_CPU_PATH)/arialbi.br:$(AS_CPU_PATH)/VcFntDat/arialbi.ccf
	 $(MODGEN) -so $(VC_STATIC_OPTIONS_Shared) -fw '$(VCFIRMWAREPATH)' -m $(VCLOD) -f '$<' -o '$@' -d vcgclass -v V1.00.0 -profile False -vc '$(VCOBJECT_Visu)' -b
endif

FONT_MODULES_Visu=$(TEMP_PATH_ROOT_Visu)/Objects/$(AS_CONFIGURATION)/$(AS_TEMP_PLC)/arial.br $(TEMP_PATH_ROOT_Visu)/Objects/$(AS_CONFIGURATION)/$(AS_TEMP_PLC)/verabd.br $(TEMP_PATH_ROOT_Visu)/Objects/$(AS_CONFIGURATION)/$(AS_TEMP_PLC)/arialbd.br $(TEMP_PATH_ROOT_Visu)/Objects/$(AS_CONFIGURATION)/$(AS_TEMP_PLC)/arialbi.br 
