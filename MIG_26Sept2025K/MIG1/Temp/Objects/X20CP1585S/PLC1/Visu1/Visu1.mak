...
PANEL_HW_SOURCE_Visu1=C:/projects/MIG/MIG_26Sept2025K/MIG1/Physical/X20CP1585S/Hardware.hw 
DIS_OBJECTS_Visu1=$(PANEL_HW_OBJECT_Visu1) $(KEYMAP_OBJECTS_Visu1)

# KeyMapping flags
$(TEMP_PATH_Visu1)/dis.PS2-Keyboard1.vco: $(AS_PROJECT_PATH)/Physical/X20CP1585S/PLC1/VC/PS2-Keyboard1.dis $(PANEL_HW_SOURCE_Visu1)
	$(VCHWPP) -f '$(PANEL_HW_SOURCE_Visu1)' -o '$(subst .vco,.vci,$(TEMP_PATH_Visu1)/dis.PS2-Keyboard1.vco)' -n Visu1 -d Visu1 -pal '$(PALFILE_Visu1)' -c '$(AS_CONFIGURATION)' -p '$(AS_PLC)' -ptemp '$(AS_TEMP_PLC)' -B 'J4.93' -L 'visapi: V*' -hw '$(CPUHWC)' -warninglevel 2 -so $(VC_STATIC_OPTIONS_Visu1) -sos $(VC_STATIC_OPTIONS_Shared) -keyboard '$(AS_PROJECT_PATH)/Physical/X20CP1585S/PLC1/VC/PS2-Keyboard1.dis' -fp '$(AS_VC_PATH)/Firmware/V4.73.2/SG4' -prj '$(AS_PROJECT_PATH)' -apj 'MIG1' -sfas -vcob '$(VCOBJECT_Visu1)'
...
KEYMAP_SOURCES_Visu1=$(AS_PROJECT_PATH)/Physical/X20CP1585S/PLC1/VC/PS2-Keyboard1.dis 
KEYMAP_OBJECTS_Visu1=$(TEMP_PATH_Visu1)/dis.PS2-Keyboard1.vco 

# All Source Objects
TXTGRP_SOURCES_Visu1=$(AS_PROJECT_PATH)/Logical/Visu1/TextGroups/Weld_Status.txtgrp \
	$(AS_PROJECT_PATH)/Logical/Visu1/TextGroups/Log_Options.txtgrp \
	$(AS_PROJECT_PATH)/Logical/Visu1/TextGroups/Head_Txt.txtgrp \
	$(AS_PROJECT_PATH)/Logical/Visu1/TextGroups/Report_Type.txtgrp 
...
FNINFO_SOURCES_Visu1=$(AS_PROJECT_PATH)/Logical/Visu1/Fonts/DefaultFont.fninfo \
	...
	$(AS_PROJECT_PATH)/Logical/Visu1/Fonts/Arial12pxBold.fninfo \
	$(AS_PROJECT_PATH)/Logical/Visu1/Fonts/Arial14pxBold.fninfo \
	$(AS_PROJECT_PATH)/Logical/Visu1/Fonts/Arial16pxBold.fninfo \
	$(AS_PROJECT_PATH)/Logical/Visu1/Fonts/Arial18pxBold.fninfo \
	$(AS_PROJECT_PATH)/Logical/Visu1/Fonts/Arial13pxBold.fninfo \
	$(AS_PROJECT_PATH)/Logical/Visu1/Fonts/Arial24pxBold.fninfo 
...
PAGE_SOURCES_Visu1=$(AS_PROJECT_PATH)/Logical/Visu1/Pages/Init_Page.page \
	$(AS_PROJECT_PATH)/Logical/Visu1/Pages/Page10_Main.page 
...
CLM_SOURCES_Visu1=$(AS_PROJECT_PATH)/Logical/Visu1/ColorMaps/Input_Style.clm \
	$(AS_PROJECT_PATH)/Logical/Visu1/ColorMaps/PowerRatio_Color.clm \
	$(AS_PROJECT_PATH)/Logical/Visu1/ColorMaps/Mach_Status_Color.clm 
...
$(PANEL_HW_VCI_Visu1): $(PANEL_HW_SOURCE_Visu1) $(VC_LIBRARY_LIST_Visu1) $(KEYMAP_SOURCES_Visu1) $(PALFILE_Visu1)
	$(VCHWPP) -f '$<' -o '$@' -n Visu1 -d Visu1 -pal '$(PALFILE_Visu1)' -c '$(AS_CONFIGURATION)' -p '$(AS_PLC)' -ptemp '$(AS_TEMP_PLC)' -B 'J4.93' -L 'visapi: V*' -verbose 'False' -profile 'False' -hw '$(CPUHWC)' -warninglevel 2 -so $(VC_STATIC_OPTIONS_Visu1) -sos $(VC_STATIC_OPTIONS_Shared) -fp '$(AS_VC_PATH)/Firmware/V4.73.2/SG4' -sfas -prj '$(AS_PROJECT_PATH)' -apj 'MIG1' -vcob '$(VCOBJECT_Visu1)'

$(PANEL_HW_OBJECT_Visu1): $(PANEL_HW_VCI_Visu1) $(VC_LIBRARY_LIST_Visu1)
	$(VCC) -f '$(subst .vco,.vci,$@)' -o '$@' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -k '$(VCVK_SOURCES_Visu1)' $(VCCFLAGS_Visu1) -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4732 -sfas
...
$(TEMP_PATH_Visu1)/page.Init_Page.vco: $(AS_PROJECT_PATH)/Logical/Visu1/Pages/Init_Page.page $(VC_LANGUAGES_Visu1)
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1) -P '$(AS_PROJECT_PATH)' -ds '$(SRC_PATH_Visu1)/StyleSheets/Color.vcs' -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4732 -sfas


$(TEMP_PATH_Visu1)/page.Page10_Main.vco: $(AS_PROJECT_PATH)/Logical/Visu1/Pages/Page10_Main.page $(VC_LANGUAGES_Visu1)
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1) -P '$(AS_PROJECT_PATH)' -ds '$(SRC_PATH_Visu1)/StyleSheets/Color.vcs' -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4732 -sfas
...
$(TEMP_PATH_Visu1)/vcs.Gray.vco: $(AS_PROJECT_PATH)/Logical/Visu1/StyleSheets/Gray.vcs
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1) -P '$(AS_PROJECT_PATH)' -ds $(DEFAULT_STYLE_SHEET_Visu1) -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4732 -sfas
...
$(TEMP_PATH_Visu1)/vcvk.VirtualKeys.vco: $(AS_PROJECT_PATH)/Logical/Visu1/VirtualKeys.vcvk
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1)  -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4732 -sfas
...
$(TEMP_PATH_Visu1)/tpr.NumPad.vco: $(AS_PROJECT_PATH)/Logical/Visu1/TouchPads/NumPad.tpr
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1) -prj 'C:/projects/MIG/MIG_26Sept2025K/MIG1/Logical/Visu1' -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4732 -sfas
...
$(TEMP_PATH_Visu1)/txtgrp.Weld_Status.vco: $(AS_PROJECT_PATH)/Logical/Visu1/TextGroups/Weld_Status.txtgrp $(VC_LANGUAGES_Visu1)
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1)  -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4732 -sfas


$(TEMP_PATH_Visu1)/txtgrp.Log_Options.vco: $(AS_PROJECT_PATH)/Logical/Visu1/TextGroups/Log_Options.txtgrp $(VC_LANGUAGES_Visu1)
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1)  -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4732 -sfas


$(TEMP_PATH_Visu1)/txtgrp.Head_Txt.vco: $(AS_PROJECT_PATH)/Logical/Visu1/TextGroups/Head_Txt.txtgrp $(VC_LANGUAGES_Visu1)
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1)  -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4732 -sfas


$(TEMP_PATH_Visu1)/txtgrp.Report_Type.vco: $(AS_PROJECT_PATH)/Logical/Visu1/TextGroups/Report_Type.txtgrp $(VC_LANGUAGES_Visu1)
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1)  -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4732 -sfas
...
$(TEMP_PATH_Visu1)/clm.Input_Style.vco: $(AS_PROJECT_PATH)/Logical/Visu1/ColorMaps/Input_Style.clm
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1)  -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4732 -sfas


$(TEMP_PATH_Visu1)/clm.PowerRatio_Color.vco: $(AS_PROJECT_PATH)/Logical/Visu1/ColorMaps/PowerRatio_Color.clm
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1)  -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4732 -sfas


$(TEMP_PATH_Visu1)/clm.Mach_Status_Color.vco: $(AS_PROJECT_PATH)/Logical/Visu1/ColorMaps/Mach_Status_Color.clm
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu1)' $(VCCFLAGS_Visu1)  -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4732 -sfas
...
$(TEMP_PATH_Visu1)/lfnt.fr.vco: $(TEMP_PATH_Visu1)/fr.lfnt $(VC_LANGUAGES_Visu1)
	 $(VCC) -f '$<' -o '$@' $(LFNTFLAGS_Visu1) $(VCCFLAGS_Visu1) -p Visu1 -sfas
$(TEMP_PATH_Visu1)/lfnt.zh-CN.vco: $(TEMP_PATH_Visu1)/zh-CN.lfnt $(VC_LANGUAGES_Visu1)
	 $(VCC) -f '$<' -o '$@' $(LFNTFLAGS_Visu1) $(VCCFLAGS_Visu1) -p Visu1 -sfas
$(TEMP_PATH_Visu1)/lfnt.de.vco: $(TEMP_PATH_Visu1)/de.lfnt $(VC_LANGUAGES_Visu1)
	 $(VCC) -f '$<' -o '$@' $(LFNTFLAGS_Visu1) $(VCCFLAGS_Visu1) -p Visu1 -sfas
$(TEMP_PATH_Visu1)/lfnt.pt-BR.vco: $(TEMP_PATH_Visu1)/pt-BR.lfnt $(VC_LANGUAGES_Visu1)
	 $(VCC) -f '$<' -o '$@' $(LFNTFLAGS_Visu1) $(VCCFLAGS_Visu1) -p Visu1 -sfas
...
$(TEMP_PATH_Visu1)/lfnt.pt.vco: $(TEMP_PATH_Visu1)/pt.lfnt $(VC_LANGUAGES_Visu1)
	 $(VCC) -f '$<' -o '$@' $(LFNTFLAGS_Visu1) $(VCCFLAGS_Visu1) -p Visu1 -sfas
LFNT_OBJECTS_Visu1=$(TEMP_PATH_Visu1)/lfnt.sv.vco $(TEMP_PATH_Visu1)/lfnt.fr.vco $(TEMP_PATH_Visu1)/lfnt.zh-CN.vco $(TEMP_PATH_Visu1)/lfnt.de.vco $(TEMP_PATH_Visu1)/lfnt.pt-BR.vco $(TEMP_PATH_Visu1)/lfnt.es.vco $(TEMP_PATH_Visu1)/lfnt.en.vco $(TEMP_PATH_Visu1)/lfnt.pt.vco 

#Runtime Object
$(VCR_OBJECT_Visu1) : $(VCR_SOURCE_Visu1)
	$(VCC) -f '$<' -o '$@' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -sl en $(VCCFLAGS_Visu1) -rt  -p Visu1 -so $(VC_STATIC_OPTIONS_Visu1) -vcr 4732 -sfas
...
$(TEMP_PATH_Visu1)/Visu101.ccf: $(LIB_SHARED) $(SHARED_CCF) $(LIB_BMP_RES_Visu1) $(TEMP_PATH_Visu1)/Visu103.ccf $(LIB_LOCAL_RES_Visu1) $(TEMP_PATH_Visu1)/Visu102.ccf $(DIS_OBJECTS_Visu1) $(PAGE_OBJECTS_Visu1) $(VCS_OBJECTS_Visu1) $(VCVK_OBJECTS_Visu1) $(VCRT_OBJECTS_Visu1) $(TPR_OBJECTS_Visu1) $(TXTGRP_OBJECTS_Visu1) $(LAYER_OBJECTS_Visu1) $(VCR_OBJECT_Visu1) $(TDC_OBJECTS_Visu1) $(TRD_OBJECTS_Visu1) $(TRE_OBJECTS_Visu1) $(PRC_OBJECTS_Visu1) $(SCR_OBJECTS_Visu1)
	...
	$(LINK) '$@.lfl' -o '$@' -p Visu1 -lib '$(LIB_LOCAL_OBJ_Visu1)' -P '$(AS_PROJECT_PATH)' -m 'local objects' -profile 'False' -warningLevel2 -vcr 4732 -sfas
# 01 Module END
...
$(TEMP_PATH_Visu1)/Visu102.ccf: $(LIB_SHARED) $(SHARED_CCF) $(LIB_BMP_RES_Visu1) $(TEMP_PATH_Visu1)/Visu103.ccf $(BDR_OBJECTS_Visu1) $(LFNT_OBJECTS_Visu1) $(CLM_OBJECTS_Visu1)
	...
	$(LINK) '$@.lfl' -o '$@' -p Visu1 -lib '$(LIB_LOCAL_RES_Visu1)' -P '$(AS_PROJECT_PATH)' -m 'local resources' -profile 'False' -warningLevel2 -vcr 4732 -sfas
# 02 Module END
...
$(TEMP_PATH_Visu1)/Visu103.ccf: $(LIB_SHARED) $(SHARED_CCF) $(BMGRP_OBJECTS_Visu1) $(BMINFO_OBJECTS_Visu1) $(PALFILE_Visu1)
	...
	$(LINK) '$@.lfl' -o '$@' -p Visu1 -lib '$(LIB_BMP_RES_Visu1)' -P '$(AS_PROJECT_PATH)' -m 'bitmap resources' -profile 'False' -warningLevel2 -vcr 4732 -sfas
# 03 Module END
...
vcPostBuild_Visu1 :
	$(VCC) -pb -vcm '$(TEMP_PATH_Visu1)/MODULEFILES.vcm' -fw '$(VCFIRMWAREPATH)' $(VCCFLAGS_Visu1) -p Visu1 -vcr 4732 -sfas
