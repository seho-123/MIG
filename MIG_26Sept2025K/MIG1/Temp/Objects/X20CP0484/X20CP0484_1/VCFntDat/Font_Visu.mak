...
# Font verabd
#
ifneq ($(VC_FONT_verabd),1)
VC_FONT_verabd=1
$(AS_CPU_PATH)/VcFntDat/verabd.vco:$(AS_CPU_PATH)/VcFntDat/verabd.vci
	 $(VCC) -f '$<' -o '$@' $(TTFFLAGS_Visu) $(VCCFLAGS_Visu) -sfas

$(AS_CPU_PATH)/VcFntDat/verabd.ccf:$(AS_CPU_PATH)/VcFntDat/verabd.vco
	 $(LINK) '$^' -o '$@' -warningLevel2 -m verabd.ttf -name Visu -profile 'False' -vcr 4520 -sfas

$(AS_CPU_PATH)/verabd.br:$(AS_CPU_PATH)/VcFntDat/verabd.ccf
...
$(AS_CPU_PATH)/VcFntDat/arialbi.ccf:$(AS_CPU_PATH)/VcFntDat/arialbi.vco
	 $(LINK) '$^' -o '$@' -warningLevel2 -m arialbi.ttf -name Visu -profile 'False' -vcr 4520 -sfas
...
FONT_MODULES_Visu=$(TEMP_PATH_ROOT_Visu)/Objects/$(AS_CONFIGURATION)/$(AS_TEMP_PLC)/verabd.br $(TEMP_PATH_ROOT_Visu)/Objects/$(AS_CONFIGURATION)/$(AS_TEMP_PLC)/arialbi.br $(TEMP_PATH_ROOT_Visu)/Objects/$(AS_CONFIGURATION)/$(AS_TEMP_PLC)/arial.br $(TEMP_PATH_ROOT_Visu)/Objects/$(AS_CONFIGURATION)/$(AS_TEMP_PLC)/arialbd.br 
