...
PANEL_HW_SOURCE_Visu1=C:/projects/MIG/MIG_26Sept2025K/MIG1/Physical/X20CP1685S/Hardware.hw 
DIS_OBJECTS_Visu1=$(PANEL_HW_OBJECT_Visu1) $(KEYMAP_OBJECTS_Visu1)

# KeyMapping flags
$(TEMP_PATH_Visu1)/dis.PS2-Keyboard1.vco: $(AS_PROJECT_PATH)/Physical/X20CP1685S/PLC1/VC/PS2-Keyboard1.dis $(PANEL_HW_SOURCE_Visu1)
	$(VCHWPP) -f '$(PANEL_HW_SOURCE_Visu1)' -o '$(subst .vco,.vci,$(TEMP_PATH_Visu1)/dis.PS2-Keyboard1.vco)' -n Visu1 -d Visu1 -pal '$(PALFILE_Visu1)' -c '$(AS_CONFIGURATION)' -p '$(AS_PLC)' -ptemp '$(AS_TEMP_PLC)' -B 'J4.93' -L 'visapi: V*' -hw '$(CPUHWC)' -warninglevel 2 -so $(VC_STATIC_OPTIONS_Visu1) -sos $(VC_STATIC_OPTIONS_Shared) -keyboard '$(AS_PROJECT_PATH)/Physical/X20CP1685S/PLC1/VC/PS2-Keyboard1.dis' -fp '$(AS_VC_PATH)/Firmware/V4.73.2/SG4' -prj '$(AS_PROJECT_PATH)' -apj 'MIG1' -sfas -vcob '$(VCOBJECT_Visu1)'
...
KEYMAP_SOURCES_Visu1=$(AS_PROJECT_PATH)/Physical/X20CP1685S/PLC1/VC/PS2-Keyboard1.dis 
